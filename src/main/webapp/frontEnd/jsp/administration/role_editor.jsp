...
<body>
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
							<div class="fh5co-intro fh5co-table-cell animate-box">
								<h1 class="text-center">Role editor</h1>
								<div class="animate-box">
									...
									<div class="form-group">
										<input type="Save" class="btn btn-send-message btn-md"
											   value="Save" onclick="update_role()">

										<input type="Delete" class="btn btn-send-message btn-md"
											   value="Delete" onclick="delete_role()">
									</div>
								</div>
							</div>
						</div>
	...
	<script src="${pageContext.request.contextPath}/ajax/administration/role_editor.js"></script>
