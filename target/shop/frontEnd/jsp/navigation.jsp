...
<nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <h2 id="fh5co-logo"><a href="${pageContext.request.contextPath}/index">Computer equipment<span>  internet-shop</span></a></h2>
        </div>
            ...
            <ul class="nav navbar-nav" id="fh5co-primary-menu">
                ...
                <li>
                    ...
                    <ul class="fh5co-sub-menu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/administration?pageName=orders">Orders</a></li>
                    </ul>
                </li>
            </ul>
        </div>
